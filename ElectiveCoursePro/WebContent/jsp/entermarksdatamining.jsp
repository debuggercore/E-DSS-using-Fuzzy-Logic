  ...
  <div class="form">
    ...
    <form action="<%=request.getContextPath()%>/elective/predictElectiveFuzzy.do" method="post">
     	...
     	<input type="text" name="subject1"/>
      	...
      	<input type="text" name="subject1Name" value="DataStructuresWithJava" readonly/>
      ...
      <input type="text" name="electiveNamePart1" value="datamining1" readonly/>
      
      <label>Enter Elective Subject Name</label>
      <input type="text" name="electiveName" value="datamining" readonly/>
      
      <input type="hidden" name="pageName" value="entermarksdatamining"/>
