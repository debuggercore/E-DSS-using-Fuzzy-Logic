  ...
  <div class="form">
    ...
    <form action="<%=request.getContextPath()%>/elective/predictElective.do" method="post">
     	...
     	<input type="text" name="subject1"/>
      	...
      	<input type="text" name="subject1Name" value="DATA STRUCTURES WITH JAVA" readonly/>
      ...
      <input type="text" name="electiveName" value="DATA MINING" readonly/>
      
      <input type="hidden" name="pageName" value="c45entermarksdatamining"/>
