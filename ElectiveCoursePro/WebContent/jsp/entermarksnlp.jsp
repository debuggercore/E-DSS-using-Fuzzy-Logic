...
<div class="module form-module">
  ...
  <div class="form">
    ...
    <form action="<%=request.getContextPath()%>/elective/predictElectiveFuzzy.do" method="post">
     	
     	<label>Enter Subject1 Marks</label> 
     	<input type="text" name="subject1"/>
     	
      	<label>Enter Subject1 Name</label> 
      	<input type="text" name="subject1Name" value="FiniteAutomataandFormalLanguages" readonly />
      
      	<label>Enter Subject2 Marks</label> 
      	<input type="text" name="subject2"/>
      	
      <label>Enter Subject2 Name</label>
      <input type="text" name="subject2Name" value="AnalysisandDesignofAlgorithms" readonly/>
      
      <label>Enter Elective Fuzzy File Part1</label>
      <input type="text" name="electiveNamePart1" value="nlp1" readonly/>      
      
      <label>Enter Elective Subject Name</label>
      <input type="text" name="electiveName" value="NaturalLanguageProcessing" readonly/>
      
      <input type="hidden" name="pageName" value="entermarksnlp"/>
