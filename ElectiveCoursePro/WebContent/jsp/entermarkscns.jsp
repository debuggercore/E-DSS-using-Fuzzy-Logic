  ...
  <div class="form">
    ...
    <form action="<%=request.getContextPath()%>/elective/predictElectiveFuzzy.do" method="post">
     	...
     	<input type="text" name="subject1"/>
      	...
      	<input type="text" name="subject1Name" value="ComputerNetworks" readonly/>
      
      	<label>Enter Subject2 Marks</label> 
      	<input type="text" name="subject2"/>
      	
      <label>Enter Subject2 Name</label>
      <input type="text" name="subject2Name" value="OperatingSystems" readonly/>     
      
      
      <label>Enter Elective Fuzzy File Part1</label>
      <input type="text" name="electiveNamePart1" value="cns1" readonly/>     
      
      
      <label>Enter Elective Subject Name</label>
      <input type="text" name="electiveName" value="ComputerAndNetworkSecurity" readonly/>
      
      <input type="hidden" name="pageName" value="entermarkscns"/>
