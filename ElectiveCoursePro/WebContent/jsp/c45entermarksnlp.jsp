  ...
  <div class="form">
    ...
    <form action="<%=request.getContextPath()%>/elective/predictElective.do" method="post">
     	...
     	<input type="text" name="subject1"/>
      	...
      	<input type="text" name="subject1Name" value="FINITE AUTOMATA AND FORMAL LANGUAGES" readonly/>
      
      	<label>Enter Subject2 Marks</label> 
      	<input type="text" name="subject2"/>
      	
      <label>Enter Subject2 Name</label>
      <input type="text" name="subject2Name" value="ANALYSIS AND DESIGN OF ALGORITHMS" readonly/>
      
      
      <label>Enter Elective Subject Name</label>
      <input type="text" name="electiveName" value="NATURAL LANGUAGE PROCESSING" readonly/>
      
      <input type="hidden" name="pageName" value="c45entermarksnlp"/>
